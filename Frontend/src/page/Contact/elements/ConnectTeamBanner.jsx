...
const ConnectTeamBanner = ({ connectTeamBannerData, contactFormDetails }) => {
                ...
                <div className="h-[100px] w-[100%] lg:w-[48%] p-2 flex justify-start gap-3 items-center">
                  <ul className="flex justify-start gap-8 items-center w-full">
                    {contactLinks.map((cl, index) => {
                      return (
                        <li className="h-[40px] w-[40px] bg-[var(--secondary-color)] rounded-md flex justify-center items-center">
...
export default ConnectTeamBanner;
