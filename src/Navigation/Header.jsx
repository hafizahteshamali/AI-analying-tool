    ...
    <>
      <div className="container mx-auto">
        <div className="w-[100%] bg-[#E5E7EB] rounded-lg px-5 py-2 flex justify-between items-center">
          <NavLink to="/">
            <img src="/assets/images/Home/LOGO.png" className="h-[70px] w-[120px] p-1 object-contain" alt="" />
          </NavLink>
          ...
          <ul className="hidden lg:flex justify-center items-center gap-5">
            {NavigationData.map((nav, index) => {
              return (
                <li key={index}>
                  <NavLink className="text-[var(--secondary-color)] font-[500]" to={nav.url}>
                    {nav.text}
                  </NavLink>
                </li>
              )
                ...
                <div className="h-[400px] w-[90%] mx-auto">
                  ...
                  <ul className="flex flex-col gap-7 my-10">
                    <>
                      ...
                      <li>
                        <NavLink onClick={Logout} className="text-xl text-[var(--secondary-color)] font-[500]" to="">
                          Abmelden
                        </NavLink>
                      </li>
                    </>
      ...
      >
        ...
        <ul className="flex flex-col justify-center mx-0 items-start gap-5">
          {NavigationData.map((item, index) => {
            return (
              <li key={index}>
                <NavLink className="text-[var(--secondary-color)] text-xl font-[500]" to={item.url}>
                  {item.text}
                </NavLink>
              </li>
            )
            ...
            >
              <div className="w-[100%] flex my-3 justify-between items-center">
                <div className="flex-col w-[48%]">
                  ...
                  />
                  {signupForm.formState.errors.fname && <span>This field is required</span>}
                </div>
                ...
                <div className="flex-col w-[48%]">
                  ...
                  <input
                    ...
                    className="h-[50px] w-[100%] bg-white rounded-lg border-2 border-[var(--black-color)] p-5 outline-none"
                  />
                  {signupForm.formState.errors.lname && <span>This field is required</span>}
                </div>
              </div>
            ...
            >
              <div className="w-[100%] flex flex-col my-3 justify-center items-start">
                ...
                <input
                  ...
                  className="h-[50px] w-[100%] bg-white rounded-lg border-2 border-[var(--black-color)] p-5 outline-none"
                />
                {loginForm.formState.errors.email && <span>This field is required</span>}
              </div>
              ...
              <div className="w-[100%] flex flex-col my-3 justify-center items-start">
                ...
                <input
                  ...
                  className="h-[50px] w-[100%] bg-white rounded-lg border-2 border-[var(--black-color)] p-5 outline-none"
                />
                {loginForm.formState.errors.password && <span>This field is required</span>}
              </div>

              <NavLink onClick={forgotPassOpenLoginClose} className="text-[var(--secondary-color)] mb-3">
                Passwort vergessen?
              </NavLink>
            ...
            >
              <div className="w-[100%] flex flex-col my-3 justify-center items-start">
                ...
                <input
                  ...
                  className="h-[50px] w-[100%] bg-white rounded-lg border-2 border-[var(--black-color)] p-5 outline-none"
                />
                {forgotForm.formState.errors.email && <span>This field is required</span>}
              </div>
          ...
          <div className="w-[100%] lg:w-[45%] mx-auto py-3 flex flex-col justify-start items-center">
            ...
            >
              <div className="w-[100%] flex flex-col my-3 justify-center items-start">
                ...
                />
                {resetForm.formState.errors.newPassword && <span>This field is required</span>}
              </div>
              ...
              <div className="w-[100%] flex flex-col my-3 justify-center items-start">
                ...
                <input
                  ...
                  className="h-[50px] w-[100%] bg-white rounded-lg border-2 border-[var(--black-color)] p-5 outline-none text-black"
                />
                {resetForm.formState.errors.cPassword && <span>This field is required</span>}
              </div>
      ...
      <Modal isOpen={isOptModalShow} onClose={() => setIsOptModalShow(false)}>
        ...
        <div className="h-[100%] w-[100%] px-5 py-6 bg-[var(--white-color)] rounded-lg flex justify-center items-center">
          <div className="w-[100%] lg:w-[45%] mx-auto py-3 flex flex-col justify-start items-center">
            ...
            <p className="mb-8 text-[12px]">Ein OTP-Code wurde an *******{isEmail} gesendet.</p>
            ...
            >
              <div className="flex gap-3 w-full justify-between">
                {[...Array(6)].map((_, index) => (
                  <input
                    ...
                    type="text"
                    maxLength="1"
                    className="w-[60px] h-[60px] text-center text-xl border-2 border-black rounded-lg"
              ...
              <input
                type="submit"
                value="Verifizieren"
                className="mt-6 h-[50px] w-[100%] bg-[var(--green-color)] text-center text-[var(--white-color)] text-xl rounded-lg"
              />
            </form>
      ...
      <Modal isOpen={isPremiumModal} onClose={() => setIsPremiumModal(false)}>
        ...
        <div className="w-full px-5 py-6 bg-[var(--white-color)] rounded-lg flex flex-col justify-center items-center">
          <div className="flex flex-col justify-center items-center">
            <h1 className="text-3xl lg:text-5xl text-[var(--secondary-color)] font-[500]">
